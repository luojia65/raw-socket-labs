...
fn main() {
    ...
    let virtual_dev_ip_addr = IpAddress::from([0xfe80, 0, 0, 0, 0x215, 0x5dff, 0xfe5e, 0x93a7]);
    ...
    ip.set_dst_addr(IpAddress::from([0xfe80, 0, 0, 0, 0x6c55, 0x6581, 0x7772, 0xb3d4]));
