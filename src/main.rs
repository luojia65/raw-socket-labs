...
fn main() {
    ...
    let virtual_dev_eui48 = "00-15-5d-5e-98-8f".parse().unwrap();
    let virtual_dev_ip_addr = IpAddress::from([0xfe80, 0, 0, 0, 0x215, 0x5dff, 0xfe5e, 0x988f]);
    ...
    ip.payload_mut()[..64].copy_from_slice(&[
